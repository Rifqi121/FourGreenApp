            ...
            children: <Widget>[
              ...
              new Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    new Icon(Icons.shopping_bag_outlined, size: 20,),
                    SizedBox(width: 20,),
            ...
            children: <Widget>[
              ...
              new Container(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    new Icon(Icons.mark_chat_read_outlined),
                    SizedBox(width: 20,),
                    new Text("Chat dengan Fourgreen Company"),
                    SizedBox(width: 2,),
                    new Icon(Icons.arrow_right)
                  ],
                ),
            ...
            child: Column(
              children: <Widget>[
                Container(
                  ...
                  height: 50,
                  decoration: BoxDecoration(
                      image: DecorationImage(image: AssetImage('assets/icon/mahkota.jpeg'))
                  ),
                ),
                new Center(
                  child: Column(
            ...
            child: Column(
              children: <Widget>[
                Container(
                  ...
                  height: 60,
                  decoration: BoxDecoration(
                      image: DecorationImage(image: AssetImage('assets/icon/piagam.jpeg'))
                  ),
                ),
                new Center(
                  child: Column(
            ...
            child: Column(
              children: <Widget>[
                Container(
                  ...
                  height: 50,
                  decoration: BoxDecoration(
                      image: DecorationImage(image: AssetImage('assets/icon/kupon.jpeg'))
                  ),
                ),
                new Center(
                  child: Column(
